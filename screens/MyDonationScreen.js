  ...
  /*getAllDonations = () => {
    this.requestRef = db.collection("all_donations").where("donor_id", '==', this.state.userId)
      .onSnapshot((snapshot) => {
        ...
        console.log("all_donations", allDonations);
        this.setState({
...
*/
  ...
  sendNotification = (booksDetails, requestStatus) => {
    var requestId = booksDetails.request_id
    var donorId = booksDetails.donor_id
  ...
  sendBook = (booksDetails) => {
    console.log("bookDetails",booksDetails)
    if (booksDetails.request_status === "Donor Interested") {
      var requestStatus = "Book Sent"
      db.collection("all_donations").doc(booksDetails.doc_id).update({
        request_status: requestStatus
      })

      this.sendNotification(booksDetails, requestStatus)
    }
    else {
      var requestStatus = "Book Sent"
      db.collection("all_donations").doc(booksDetails.doc_id).update({
